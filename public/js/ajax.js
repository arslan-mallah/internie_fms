    ...
    $.ajax({
        ...
        success:function(data){
            ...
            <div class="w-75">\
                ...
                <button id="filter"  class="btn btn-primary mx-2" onclick="filterDataa()">Filter</button>\
                <button id="reset" class="btn btn-danger mx-2"  onclick="resetDataa()">Reset</button>\
            </div>\
            </div>';
